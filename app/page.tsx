          ...
          <div className="md:col-span-2 lg:col-span-2 rounded-3xl bg-white/[0.03] border border-white/10 p-6 flex flex-col justify-between">
            <div>
              ...
              <p className="text-xs text-zinc-300 leading-relaxed mb-3">
                Διαθέτω εξαιρετική οργάνωση, προσαρμοστικότητα και αποδεδειγμένη αντοχή σε απαιτητικά περιβάλλοντα εργασίας με αυξημένη πίεση.
              </p>
              {ethicOpen && (
                <div className="pt-2 pb-3 border-t border-white/10 space-y-1.5 text-xs text-zinc-300">
                  <p>• Μεθοδική αντιμετώπιση προβλημάτων σε περιβάλλοντα Linux/Homelab.</p>
                  <p>• Συνεχής εκμάθηση νέων τεχνολογιών και αυτοματισμών.</p>
                </div>
              )}
            </div>
 ...
 //     \\\\
        ...
        <section id="contact" className="rounded-3xl border border-white/10 bg-white/[0.02] p-8 space-y-6 animate-fade-in-up delay-400">
          <div>
            ...
            <p className="text-xs text-zinc-400 mb-6">Επιλέξτε πακέτο από πάνω και στείλτε μου τα στοιχεία σας.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <textarea required rows={4} placeholder="Περιγράψτε το project ή το αίτημά σας..." value={formData.message} onChange={(e) => setFormData({ ...formData, message: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/[0.03] border border-white/10 text-white text-sm placeholder:text-zinc-600 focus:outline-none focus:border-cyan-500/50 transition-all resize-none" />
            </div>
