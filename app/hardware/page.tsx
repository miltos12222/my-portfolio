...
import { Check, Cpu, ArrowRight, ArrowLeft, Send, ShoppingBag, Briefcase } from "lucide-react";
...
export default function HardwarePage() {
    ...
    const [selectedBuild, setSelectedBuild] = useState("Homelab / Proxmox Server Build");
            ...
            <main className="relative w-full pt-32 pb-32 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto space-y-10">
                ...
                <div className="text-center max-w-2xl mx-auto space-y-3">
                    ...
                    <p className="text-sm text-zinc-400">
                        Εξειδικευμένο στήσιμο διακομιστών Homelab, σταθμών εργασίας AI/Development και Custom συστημάτων.
                    </p>
                </div>
                ...
                {step === 1 ? (
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center justify-between pt-4 border-t border-white/5">
                                            <span className="text-xl font-bold font-mono text-white">Αμοιβή: {pkg.price}€</span>
                    ...
                    <div className="space-y-6 animate-fade-in max-w-2xl mx-auto">
                        <div className="bg-white/[0.03] border border-emerald-500/30 p-6 rounded-3xl space-y-3">
                            ...
                            <p className="text-xs text-zinc-200">• Χρήση: <strong className="text-white">{buildType}</strong></p>
                        </div>
                        ...
                        <div className="bg-white/[0.02] border border-white/10 p-8 rounded-3xl space-y-6">
                            ...
                            <form onSubmit={handleHardwareSubmit} className="space-y-5">
                                ...
                                <div>
                                    ...
                                    <textarea rows={4} placeholder="Αναφέρετε το διαθέσιμο budget σας ή συγκεκριμένα εξαρτήματα..." value={formData.message} onChange={(e) => setFormData({ ...formData, message: e.target.value })} className="w-full px-4 py-3 rounded-xl bg-white/[0.03] border border-white/15 text-sm focus:outline-none focus:border-emerald-500 resize-none" />
                                </div>
