...
import { Check, ShoppingBag, ArrowRight, Briefcase, Cpu, Server, ShoppingCart } from "lucide-react";
...
export default function ServicesPage() {
    ...
    // Add selected add-ons to cart in bulk
                            ...
                            <div key={i} className="p-6 rounded-3xl border bg-white/[0.02] border-white/10 hover:border-white/20 transition-all flex flex-col justify-between">
                                ...
                                <div className="flex items-center justify-between pt-4 border-t border-white/5">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-black font-bold text-xs transition-all shadow cursor-pointer"
                                    >
                ...
                <div className="space-y-6 max-w-3xl mx-auto pt-8">
                    ...
                    <div className="bg-white/[0.02] border border-white/10 p-6 sm:p-8 rounded-3xl space-y-4">
                        {addonsList.map((addon) => {
                            ...
                            return (
                                <div key={addon.id} onClick={() => toggleAddon(addon.id)} className={`p-4 rounded-2xl border cursor-pointer flex items-center justify-between transition-all ${isChecked ? "bg-purple-500/10 border-purple-500" : "bg-white/[0.02] border-white/10"}`}>
                        ...
                        <div className="pt-4 flex justify-end">
                            <button
                                ...
                                className="px-6 py-3 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-bold text-xs transition-all shadow cursor-pointer flex items-center gap-2"
                            >
